...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: "What type of investment structure do you offer?",
      answer: "Madini Moyoni offers multiple investment structures: Equity Only (30% equity, 9.9x return, 64% IRR), Equity + Dividend (20% equity + 20% profit dividends, 3.9x return, 34% IRR), and Strategic (6.0x return, 81% IRR). Investment ranges from $5,000 Foundation tier (UK investors) to $5,000,000 maximum. Our investment structure is designed for international investors from the UK, US, and Cayman Islands."
    },
    {
      question: "What's the investment process and timeline?",
      answer: "1) Initial consultation (within 48 hours) 2) Due diligence pack provided 3) Investment agreement signed 4) Funds transferred 5) Share certificates issued 6) Regular progress updates commence. Total process typically takes 2-4 weeks from initial contact to investment completion."
    },
    {
    ...
    },
    {
      ...
      answer: "Returns depend on operational success of mechanisation and copper extraction. Professional mechanisation of artisanal operations will transform current mining activities. We offer three structures: Equity Only (9.9x return, 64% IRR, 30% equity), Equity + Dividend (3.9x return, 34% IRR, 20% equity + dividends), or Strategic (6.0x return, 81% IRR, convertible preferred)."
    },
    {
    ...
    },
    {
      ...
      answer: "Investment tiers: Foundation ($5,000-$25,000, UK investors), Pioneer ($25,000-$100,000), Voyager ($100,000-$500,000), Navigator ($500,000-$1,000,000), and Founder (Over $1,000,000). All investments provide same financial returns through our three structures: Equity Only (9.9x return, 64% IRR), Equity + Dividend (3.9x return, 34% IRR), or Strategic (6.0x return, 81% IRR). Larger investments receive enhanced engagement opportunities including site visits and strategic participation."
    },
    {
      question: "What documentation will I receive?",
      answer: "All investors receive: Share certificates, investment agreement, company memorandum & articles, quarterly progress reports and annual impact statements. We maintain transparent communication throughout with full audit trails. Enhanced benefits and exclusive engagement opportunities are available based on investment level."
    },
    {
      question: "What are the main risks of this investment?",
      answer: "Key risks include: operational mining risks, commodity price volatility, political/regulatory changes in Tanzania, currency fluctuations, and general early-stage company risks. Mining operations may face technical challenges or delays. We mitigate risks through experienced local partnerships, proven mining sites, and staged investment deployment."
    },
    {
